      ...
      <div className="accountnav">
        ...
        <div className="help">
         ...
         {pro? <div className="logout">
            ...
            <p className="line"><img src="	https://myaccount.ackoassets.com/static/images/header-icons/my-profile-v2.svg"/> My Profile</p>
      ...
      <div className="accountdiv">
          <div className="maindiv">
             <div className="mypolicy">
                 ...
                 <div>
                 <div className="li">
                  <div className="liimg"><img className="srcimg" src="https://acko-public.s3.ap-south-1.amazonaws.com/partnership/logos/Rapido_jan_2021.svg"/></div>
                  <div className="pdiv">
                 ...
                 <div>
                 <div className="li">
                  <div className="liimg"><img className="srcimg" src="https://acko-public.s3.ap-south-1.amazonaws.com/partnership/logos/Oyo_jan_2021.svg"/></div>
                  <div className="pdiv">
                 ...
                 <div>
                 <div className="li">
                  <div className="liimg"><img className="srcimg" src="https://acko-public.s3.ap-south-1.amazonaws.com/partnership/logos/Ola_jan_2021.svg"/></div>
                  <div className="pdiv">
                  ...
                  <div className="li">
                  <div className="liimg liimg1"><img src="https://container-app.ackoassets.com/am/myaccount_frontend/1385c1cbb19d9f70252d3fbce4d86fff.svg"/></div>
                  <div className="pdiv">
                    <p className="pdiv3">Have a Corporate Health Policy from ACKO?</p>
                    <p className="pdiv2">Install the ACKO to access your benifits</p>
                  </div>
                  </div>
                  <div className="li none">
                    <p className="request">How to raise repair request for your mobile or appliance:</p>
                    <div className="appliances">
                    <div className="raiserepair">
                      <img src="https://myaccount.ackoassets.com/static/images/screen_spanner_cell.svg"/>
                      <p>Register a repair request by selecting mobile or appliance plan</p>
                    </div>
                    <div className="arrow"><img src="https://container-app.ackoassets.com/am/myaccount_frontend/560861c475dacf39e7d2d923b24b89e2.svg"/></div>
                    <div className="raiserepair">
                      <img src="https://myaccount.ackoassets.com/static/images/repairpaper_index.svg"/>
                      <p>Click on 'Repair on the policy page & follow the steps'</p>
                    </div>
                    <div className="arrow"><img src="https://container-app.ackoassets.com/am/myaccount_frontend/560861c475dacf39e7d2d923b24b89e2.svg"/></div>
                    <div className="raiserepair">
                      <img src="https://myaccount.ackoassets.com/static/images/hand_coin.svg"/>
                      <p>Submit your request after selecting mode of settlement</p>
                    </div>
                    <div className="arrow"><img src="https://container-app.ackoassets.com/am/myaccount_frontend/560861c475dacf39e7d2d923b24b89e2.svg"/></div>
                    <div className="raiserepair">
                  ...
                  <div className="li1">
                  <div className="liimg liimg1 liimg2"><img src="https://container-app.ackoassets.com/am/myaccount_frontend/608eca5bbd4a5b668eb6d6aed4c028cc.svg"/></div>
                  <div className="pdiv">
                    <p className="pdiv3">Download Acko App on your phone</p>
                    <p className="pdiv2">Manage your policies & claims on the go</p>
                  </div>
                  </div>
                 </div>
             </div>
