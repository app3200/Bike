      ...
      <div className='dropdown-box'>
        <div className='dropdown-box-item'>
          <div className='dropdown-heading-div'>
            <span className='dropdown-heading-svg'>
              <svg
                width='32'
                height='32'
                viewBox='0 0 32 32'
            ...
            <p className='dropdown-heading-text'>Car &amp; taxi</p>
          </div>
        ...
        <div className='dropdown-box-item'>
          <div className='dropdown-heading-div'>
            ...
            <p className='dropdown-heading-text'>Bike</p>
          </div>
          <a className='dropdown-links' href='/'>
        ...
        <div className='dropdown-box-item'>
          <div className='dropdown-heading-div'>
            ...
            <p className='dropdown-heading-text'>Health</p>
          </div>
          <a className='dropdown-links' href='/'>
            Health Insurance
          </a>
        ...
        <div className='dropdown-box-item'>
          <div className='dropdown-heading-div'>
            ...
            <p className='dropdown-heading-text'>Electronics</p>
          </div>
          <a className='dropdown-links' href='/'>
            Mobile Protection
          </a>
