  ...
  return (
    <div className='resource-dropdown'>
      <div className='resources-dropdown-menu'>
        <a href='' className='resources-links'>
          <span className='resources-svg-span'>
            <svg
              width='24'
              height='24'
              viewBox='0 0 24 24'
          ...
          <p className='resources-link-text'>All Resources</p>
        </a>
        <a href='' className='resources-links'>
          <span className='resources-svg-span'>
            <svg
          ...
          <p className='resources-link-text'>Guides</p>
        </a>
        <a href='' className='resources-links'>
          <span className='resources-svg-span'>
            <svg
          ...
          <p className='resources-link-text'>Articles</p>
        </a>
      </div>
    </div>
  );
